...
class Template
{
  ...
  public function emailResestPasswordTemplate($password): string
  {
    return <<<HTML
    <!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
    <html xmlns="http://www.w3.org/1999/xhtml">
                      ...
                      <td style="padding: 40px 0px 0px">
                        ...
                        >
                          <div style="color: rgb(0, 0, 0); text-align: left">
                            <h1 style="margin: 1rem 0">Account notification</h1>
                            <p style="padding-bottom: 16px">
                              You have successfully reseted an account with nmscstshims. Please use this provided <strong>password</strong> to sign in.
                            </p>
                            <p style="padding-bottom: 10px">
                              <strong style="font-size: 130%">$password</strong>
                            </p>
