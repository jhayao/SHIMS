                ...
                <div class="card bg-light-info shadow-none position-relative overflow-hidden">
                    <div class="card-body px-4 py-3">
                        <div class="row align-items-center">
                            <div class="col-9">
                                <h4 class="fw-semibold mb-8"><?php echo ($edit ? "Edit District" : "Add District"); ?></h4>
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a class="text-muted" href="district.php">District</a>
                                        </li>
                                        <li class="breadcrumb-item" aria-current="page">
                                            <?php echo ($edit ? "Edit District" : "Add District"); ?></li>
                                    </ol>
                                </nav>
                            </div>
                            <div class="col-3">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    <div class="mb-4">
                                                        ...
                                                        <input type="text" class="form-control " id="district_name"
                                                            name="district_name" placeholder="Mathew Anderson"
                                                            required>
                                                ...
                                                <div class="col-12">
                                                    <div
                                                        ...
                                                        <button class="btn btn-light-danger text-danger" onclick="window.location.href='viewDistrict.php'">Cancel</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </form>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            if ( <?php echo (isset($_GET['edit']) ? true : 0); ?> ) {
                //request ajax to get data of district by id
            ...
            var districtFormValidation = Array.prototype.filter.call(districtForm, function (form) {
            ...
            $('#districtForm').submit(function (event) {
                ...
                if (form[0].checkValidity() === false) {
                    ...
                    if( <?php echo ($edit); ?>)
                    {
                        formdata.append("function", "updateDistrict");
                        formdata.append("id", <?php echo (isset($_GET['id']) ? $_GET['id'] : 0); ?>);
                    }
                    else {
                        formdata.append("function", "addDistrict");
                    }
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            ...
                            console.log(data)
                            if (data == "success") {
                                window.location.href = "viewDistrict.php?success=1";
                            } else {
