                    ...
                    <div class="dropdown-menu content-dd dropdown-menu-end dropdown-menu-animate-up" aria-labelledby="drop1">
                      <div class="profile-dropdown position-relative" data-simplebar>
                        ...
                        <div class="d-flex align-items-center py-9 mx-7 border-bottom">
                          ...
                          <div class="ms-3">
                            <h5 class="mb-1 fs-3"><?php echo ucwords($_SESSION['userInfo']['firstname'] . " " . $_SESSION['userInfo']['lastname'])?></h5>
                            <span class="mb-1 d-block text-dark"><?php echo ucwords($_SESSION['user_type']) ?></span>
                            <p class="mb-0 d-flex text-dark align-items-center gap-2">
                              <i class="ti ti-mail fs-4"></i> <?php echo $_SESSION['userInfo']['email'] ?>
                            </p>
                          </div>
                        </div>
                        <div class="message-body">
                          <a href="accountPage.php" class="py-8 px-7 mt-8 d-flex align-items-center">
                        ...
                        <div class="d-grid py-4 px-7 pt-8">
                          ...
                          <btn id="btn-logout" class="btn btn-outline-primary">Log Out</btn>
                        </div>
                      </div>
                    </div>
                  </li>
