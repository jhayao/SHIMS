                ...
                <div class="card bg-light-info shadow-none position-relative overflow-hidden">
                    <div class="card-body px-4 py-3">
                        <div class="row align-items-center">
                            <div class="col-9">
                                <h4 class="fw-semibold mb-8">List of Divisions</h4>
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a class="text-muted" href="division.php">Division</a>
                                        </li>
                                        <li class="breadcrumb-item" aria-current="page">List of Divisions</li>
                                    </ol>
                                </nav>
                            </div>
                            <div class="col-3">
        ...
        $(document).ready(function() {
            ...
            var table = $('#file_export').DataTable({
                ...
                ajax: {
                    ...
                    "type": "POST",
                    "data": {
                        "function": "<?php echo (isset($_GET['archived']) && $_GET['archived'] === 'true') ? 'getAllDivisionArchived' : 'getAllDivision' ?>"
                    },
                },
                columns: [{
                        "data": "id"
                        ...
                        "render": function(data, type, row, meta) {
                            return `<div class="d-flex">
                                        ...
                                        <?php if (isset($_GET['archived']) && $_GET['archived'] === 'true') : ?>
                                                                                ...
                                                                                <?php else : ?>
                                                                                            <a href="addDivision.php?edit=true&id=${data}"  class="btn btn-primary unarchived me-2"><i class="ti <?php echo ((isset($_GET['archived']) && $_GET['archived'] === 'true') ? "ti-archive-off" : "ti-edit") ?> "></i></a>
                                                                                    <?php endif; ?>
